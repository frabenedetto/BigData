...
public class FacBTest {
	...
	public static void main(String[] args){
		...
		ArrayList<HashSet<HashSet<String>>> productSets = new ArrayList<HashSet<HashSet<String>>>(3);
		...
		for(HashSet<HashSet<String>> hs: productSets){
			for(HashSet<String> hs_s: hs){
				System.out.println(setToString(hs_s));
			}
		}

	}

	private static String setToString(HashSet<String> hs){
