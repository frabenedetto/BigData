...
public class Month2ProductUDTF extends GenericUDTF {
	...
	public void process(Object[] record) throws HiveException {
	    ...
	    if(dateSplitted[1].equals("1") || dateSplitted[1].equals("2") || dateSplitted[1].equals("3")) {
			for (int i = 1; i < members.length; i++)
						forward(new Object[] {date.substring(0, 6) ,members[i]});
	    }
	}
